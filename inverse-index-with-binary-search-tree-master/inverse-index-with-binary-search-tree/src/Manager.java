...
public class Manager {
    ...
    public BSTree saveWords(ArrayList<File> files) {
    ...
    public boolean exists(BSTree tree, Word word) {
        BSNode node = tree.search(tree.root, word);
        if(node == null) {
    ...
    public int count(File file, BSTree tree, String key) {
        int counter = 0;
        
        BSNode foundNode = tree.search(tree.root, new Word(key, file));
    ...
    public void show_occurs(BSTree tree, ArrayList<File> files) {
